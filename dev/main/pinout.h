...
#define PIN_LORA_MOSI       11      // SPI Master Out, Slave In
#define PIN_LORA_NSS        5       // Chip Select (active low)
#define PIN_LORA_RST        6       // Reset (active low)
#define PIN_LORA_DIO0       4       // Interrupt: RX done, TX done, CAD done
#define PIN_LORA_DIO1       8       // Interrupt: RX timeout (optional)
